...
int LCS_recur(int ROW, int COL, char* str1, char* str2);
int MAX(int a,int b);
...
int LCS_recur(int ROW, int COL, char* str1, char* str2)
{
	...
	if(str1[ROW-1] == str2[COL-1])
		return 1+LCS_recur(ROW-1, COL-1, str1, str2);
	else
		return MAX(LCS_recur(ROW-1,COL,str1,str2),LCS_recur(ROW,COL-1, str1, str2));
}
